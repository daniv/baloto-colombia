...
def test_method_has(factory_command_loader: FactoryCommandLoader) -> None:
    """
...
def test_method_get(factory_command_loader: FactoryCommandLoader) -> None:
    """
...
def test_method_get_invalid_name_raises_error(factory_command_loader: FactoryCommandLoader) -> None:
    """
...
def test_property_names(factory_command_loader: FactoryCommandLoader) -> None:
    """
