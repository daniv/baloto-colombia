...
class BalotoError(Exception):
    """
    Base Baloto exception.
    """

    exit_code: int | None = None

class BalotoRuntimeError(BalotoError, RuntimeError):
    """
    ...
    def _note(self) -> str:
        ...
        """
        return "Raised when an unexpected exception was found at run-time"
...
from pydantic import BaseModel, computed_field, ConfigDict, Field, StringConstraints, ValidationError, \
    ValidatorFunctionWrapHandler, BeforeValidator
...
class PoetryRuntimeError(Exception):
    """
