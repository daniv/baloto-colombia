...
from baloto.core.poetry.toml import PyProjectTOML
...
#         self.poetry_file = self._locate_pyproject(cwd)
#         self.pyroject = self._read_toml_file(self.poetry_file)
#         self._locker = locker
#         self._io = io
#
#     def get_project(self) -> dict[str, Any]:
#         return self.pyroject.get("project", {})
#
#     def get_tool(self) -> dict[str, Any]:
#         return self.pyroject.get("tool", {})
#
#     @property
#     def pyproject_path(self) -> Path:
#         return self.poetry_file
#
#     @staticmethod
